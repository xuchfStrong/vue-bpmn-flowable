export default {
  ...
  'Append Intermediate/Boundary Event': '添加终止事件',
  'Create Intermediate/Boundary Event': '创建终止事件',
  ...
  'Script Task': '脚本任务',
  'Call Activity': '调用活动',
  'Sub Process (collapsed)': '子过程（折叠的）',
  'Sub Process (expanded)': '子过程（展开的）',
  'Start Event': '开始事件',
  ...
  'Message Intermediate Throw Event': '信息终止事件',
  'Timer Intermediate Catch Event': '定时器捕获事件',
  'Escalation Intermediate Throw Event': '升级终止事件',
  'Conditional Intermediate Catch Event': '条件捕获事件',
  'Link Intermediate Catch Event': '链接捕获事件',
  'Link Intermediate Throw Event': '链接终止事件',
  'Compensation Intermediate Throw Event': '补偿终止事件',
  'Signal Intermediate Catch Event': '信号捕获事件',
  'Signal Intermediate Throw Event': '信号终止事件',
